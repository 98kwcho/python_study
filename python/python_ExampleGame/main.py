...
WORDS = ["apple", "banana", "cat", "dog", "elephant", "flower", "grape", "house", "ice", "jacket", "kite", "lemon", "mouse", 
         "note", "orange", "pencil", "queen", "rabbit", "sun", "tree", "umbrella", "violin", "water", "xylophone", "yellow", "zebra", 
         "book", "chair", "desk", "eraser", "fan", "globe", "hat", "ink", "juice", "key", "lamp","milk", "nest", "ocean", "plane", "quilt",
         "rock", "star", "table", "uniform", "vase", "window", "yarn", "zoo"]
